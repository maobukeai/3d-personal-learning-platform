      ...
      <div class="max-w-3xl mx-auto">
        ...
        <template v-if="activeTab === 'submit'">
            ...
            <div class="p-6 sm:p-8 space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  >
                    <button
                      class="p-2 bg-rose-500 text-white rounded-full hover:bg-rose-600 transition-all transform hover:scale-110"
          ...
          >
            ...
            <div class="flex items-center justify-center gap-4">
              <button
                class="px-6 py-2.5 rounded-xl border border-slate-200 text-slate-600 font-bold text-xs hover:bg-slate-50 transition-all"
          ...
          <div class="space-y-4">
            ...
            <template v-else>
              ...
              >
                ...
                <button
                  class="mt-4 text-xs font-bold text-rose-600 hover:underline"
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="bg-slate-800 p-6 rounded-2xl text-white">
            ...
            <button
              class="text-xs font-bold text-accent hover:text-accent/30 transition-colors flex items-center gap-1"
            >
