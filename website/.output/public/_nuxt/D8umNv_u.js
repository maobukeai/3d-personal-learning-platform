...
import { a as C } from './C5KMDVPB.js';
const D = { class: 'hero section-wrap' },
  ...
  U = ['src', 'alt'],
  j = { key: 1, class: 'card-icon' },
  q = { key: 0, class: 'mirror-empty' },
  W = N({
    __name: 'index',
    async setup(G) {
      let t, r;
      const v = k(),
        y = A(),
        { data: c } =
          (([t, r] = b(() => h('website-home', () => v.getHome()))), (t = await t), r(), t),
        { data: m } =
          (([t, r] = b(() => h('website-mirrors', () => v.getMirrors()))), (t = await t), r(), t),
        d = E(() => ({
              ...
              [
                s('section', D, [
                  s('div', P, [
                    ...
                    s('div', V, [
                      s(
                        'a',
                        { class: 'button button-primary', href: n(y).public.appBase },
                      ...
                      g(
                        ...
                        { default: _(() => [...(e[1] || (e[1] = [u('探索资源', -1)]))]), _: 1 },
                      ),
                    ]),
                  ]),
                  e[2] ||
                ...
                s('section', T, [
                  ...
                  s('div', I, [
                    ...
                    n(m)?.length ? S('', !0) : (i(), l('div', q, '镜像站正在准备中，敬请期待。')),
                  ]),
                ]),
              ],
              64,
