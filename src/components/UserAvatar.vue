  ...
  <div class="relative inline-flex shrink-0 group/avatar">
    ...
    <div
      ...
      :style="{
        ...
        boxShadow: `0 0 ${15 * frameConfig.glowIntensity}px ${frameConfig.color}${Math.round(frameConfig.glowIntensity * 255).toString(16).padStart(2, '0')}`,
    ...
    >
      ...
      >
        <div class="w-full h-full rounded-[inherit] overflow-hidden bg-[var(--bg-card)] relative z-10">
          <img
      ...
      <!-- Minimalist Shimmer -->
      <div v-if="frameConfig.hasShimmer" class="absolute inset-0 rounded-[inherit] overflow-hidden pointer-events-none z-20">
    ...
    >
      ...
      <span v-if="frameConfig.badgeText" class="uppercase tracking-tight text-[7.5px] whitespace-nowrap">{{ frameConfig.badgeText }}</span>
    </div>
