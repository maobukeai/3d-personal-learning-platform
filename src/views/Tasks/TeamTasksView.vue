...
<template>
  <div class="flex-1 flex flex-col h-full overflow-hidden" style="background-color: var(--bg-app)">
    <div
      class="h-20 px-10 flex items-center justify-between shrink-0 bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl border-b z-10 sticky top-0"
      style="border-color: var(--border-base)"
    >
      <div class="flex items-center gap-4">
        <div
          class="w-12 h-12 rounded-2xl bg-gradient-to-br from-accent to-purple-600 flex items-center justify-center shadow-lg shadow-accent/20"
        >
      ...
      <div class="flex items-center gap-6">
        <div class="relative group">
          <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            <Search
              class="w-4 h-4 text-slate-400 group-focus-within:text-accent transition-colors"
            />
          </div>
          <input
            v-model="searchQuery"
        ...
        <button
          ...
          class="group relative px-6 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-2xl font-bold overflow-hidden shadow-xl shadow-slate-900/10 dark:shadow-white/10 hover:scale-105 active:scale-95 transition-all flex items-center gap-2"
          @click="openAddDrawer"
        >
          <div
        ...
        <button
          v-else
          class="flex items-center gap-2 px-6 py-3 bg-accent text-white rounded-2xl text-xs font-bold hover:shadow-lg hover:shadow-accent/20 transition-all"
        ...
        <div v-show="activeTab === 'projects'" class="p-10">
          <div class="max-w-[1600px] mx-auto space-y-10">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div
                class="bg-white dark:bg-slate-900 rounded-[2rem] p-6 border shadow-sm flex items-center gap-6"
                style="border-color: var(--border-base)"
              >
                <div
                  class="w-14 h-14 rounded-2xl bg-blue-500/10 flex items-center justify-center shrink-0"
                >
                ...
                <div>
                  ...
                  <h3 class="text-3xl font-black" style="color: var(--text-primary)">
                    {{ projectStats.total }}
                  </h3>
                </div>
              </div>
              ...
              >
                <div
                  class="w-14 h-14 rounded-2xl bg-orange-500/10 flex items-center justify-center shrink-0"
                >
              ...
              >
                <div
                  class="w-14 h-14 rounded-2xl bg-emerald-500/10 flex items-center justify-center shrink-0"
                >
              ...
              >
                <div
                  class="w-14 h-14 rounded-2xl bg-purple-500/10 flex items-center justify-center shrink-0"
                >
            ...
            <div
              ...
              class="flex flex-col items-center justify-center py-32 text-center bg-white/50 dark:bg-slate-900/50 rounded-[3rem] border border-dashed"
              style="border-color: var(--border-base)"
            >
              <div
                class="w-24 h-24 bg-slate-100 dark:bg-white/5 rounded-full flex items-center justify-center mb-6"
              >
              ...
              <button
                class="px-8 py-3 bg-accent text-white rounded-2xl font-bold hover:scale-105 transition-all shadow-lg shadow-accent/20"
                @click="openAddDrawer"
              >
                创建第一个项目
              </button>
            ...
            >
              ...
              >
                ...
                <div class="relative z-10 flex flex-col h-full">
                  ...
                  <h3
                    class="text-lg font-black group-hover:text-accent transition-colors mb-2 line-clamp-1"
                    style="color: var(--text-primary)"
                  >
                    {{ project.title }}
                  </h3>
                  <p
                    class="text-xs leading-relaxed mb-6 line-clamp-2"
                    style="color: var(--text-secondary)"
                  >
                  ...
                  <div class="flex flex-wrap gap-2 mb-8">
                    <span
                      ...
                      :key="tag"
                      class="text-[10px] font-black px-2.5 py-1 bg-slate-100 dark:bg-slate-800 rounded-lg text-slate-500"
                      >#{{ tag }}</span
                    >
                    <span
                  ...
                  <div
                    class="flex items-center justify-between pt-5 border-t"
                    style="border-color: var(--border-base)"
                  >
                    ...
                    <div
                      class="flex items-center gap-2 px-3 py-1.5 rounded-xl text-[10px] font-black tracking-wider"
                      :class="
            ...
            <div
              v-else
              class="bg-white dark:bg-slate-900 rounded-[2.5rem] border shadow-sm overflow-hidden"
              style="border-color: var(--border-base)"
            >
        ...
        <div v-show="activeTab === 'tasks'" class="p-10">
          <div class="max-w-[1600px] mx-auto space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              >
                <div
                  class="w-14 h-14 rounded-2xl bg-accent/10 flex items-center justify-center shrink-0"
                >
              ...
              >
                <div
                  class="w-14 h-14 rounded-2xl bg-rose-500/10 flex items-center justify-center shrink-0"
                >
            ...
            <div class="flex gap-6 min-h-[500px]">
              <div
                v-for="col in columns"
                :key="col.id"
                class="flex-1 flex flex-col min-w-[300px] rounded-2xl transition-colors duration-300 overflow-hidden"
                    ...
                    >
                      <div class="flex items-center gap-2">
                        ...
                        <div
                          ...
                          class="flex items-center -space-x-1 ml-1"
                        >
                          <UserAvatar
                          ...
                          <div
                            ...
                            class="w-6 h-6 rounded-full border border-white dark:border-slate-800 bg-slate-200 dark:bg-slate-700 flex items-center justify-center text-[8px] font-bold text-slate-500"
                          >
    ...
    <Transition name="fade">
      <div v-if="isTaskDialogOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        ></div>
        <div
          class="relative w-full max-w-lg p-8 rounded-3xl shadow-2xl space-y-5 max-h-[90vh] overflow-y-auto"
          style="background-color: var(--bg-card)"
        >
          <div class="flex items-center justify-between">
