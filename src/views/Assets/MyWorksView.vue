  ...
  <div class="flex-1 flex flex-col h-full overflow-hidden" style="background-color: var(--bg-app)">
    ...
    >
      ...
      <div class="flex items-center gap-4">
        ...
        <button
          class="border px-4 py-2 rounded-xl text-sm font-bold hover:opacity-80 transition-all flex items-center gap-2"
        ...
        <button
          class="bg-accent text-white px-4 py-2 rounded-xl text-sm font-bold hover:opacity-90 transition-all shadow-lg shadow-accent/10 dark:shadow-none flex items-center gap-2"
