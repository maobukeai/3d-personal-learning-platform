...
async function main() {
  ...
  const course1 = await prisma.course.create({
    data: {
      ...
      thumbnail: 'https://images.unsplash.com/photo-1615147342761-9238e15d8b96?w=800&auto=format&fit=crop&q=60',
      lessons: {
        create: [
          { title: 'Blender 界面与基础操作', order: 1, content: '学习 Blender 的核心界面布局与视图操作。' },
          { title: '初探 3D 空间：小黄鸭建模', order: 2, content: '利用基础几何体构建一个小黄鸭。', videoUrl: 'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/Duck/glTF-Binary/Duck.glb' },
          { title: 'PBR 材质基础', order: 3, content: '理解基于物理的渲染流。', videoUrl: 'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/DamagedHelmet/glTF-Binary/DamagedHelmet.glb' },
        ]
      }
    }
  });
