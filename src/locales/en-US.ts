...
,
  ...
  tools: {
    ...
    googleWarming: {
      ...
      warmingTimeline: '15-Day Golden Warming Quest',
      ...
      questDays: {
        ...
        day2: 'Day 2: Clear Unfamiliar Devices',
        day2Desc: 'Go to Google Security, check and log out of unfamiliar devices, manage connected devices. Browse your inbox, and watch 10-15 minutes of YouTube videos.',
        day3: 'Day 3: Set Recovery Email',
        day3Desc: 'Add or update your recovery/recovery email address in security settings. Browse inbox, watch YouTube, and interact with Gemini AI chatbot.',
        day4: 'Day 4: Safety & 2FA Setup',
        day4Desc: 'Manage your two-factor authentication (2FA). Consider generating backup codes or configuring authenticator secrets. Browse inbox, watch YouTube, and use Gemini AI.',
        day5: 'Day 5: Bind Phone Number',
        day5Desc: 'Set up or bind a security phone number (recommended for long-term accounts to prevent account lockouts). Browse inbox, watch YouTube, and talk to Gemini.',
        day6: 'Day 6: Routine Active Warming',
        day6Desc: 'Perform routine activities: browse and send/receive a few normal emails, like/comment on YouTube videos, and perform web searches.',
        day7: 'Day 7: Change Account Password',
        day7Desc: 'Change the account password to complete the initial safety configuration cycle. Browse inbox, watch YouTube, and chat with Gemini.',
        day8_15: 'Days 8-15: Long-term Daily Routine Warming',
        day8_15Desc: 'Perform routine daily active warming (watch YouTube, browse emails, ask Gemini a few questions) to keep the account active until fully stable after 15 days.'
      },
