...
import { u as a } from './C5KMDVPB.js';
import { o as i, c as u, a as e, t as o } from './HnPWE_ys.js';
const l = {
    class:
  ...
  f = {
    ...
    props: {
      ...
      statusText: { type: String, default: 'Server error' },
    ...
    setup(t) {
      ...
      return (
        a({
          title: `${r.status} - ${r.statusText} | ${r.appName}`,
          script: [
            {
        ...
        (m, n) => (
          ...
          u('div', l, [
            ...
            e('div', c, [
              e(
                'h1',
                { class: 'font-medium mb-8 sm:text-10xl text-8xl', textContent: o(t.status) },
                null,
                8,
                d,
              ),
  ...
  x = s(f, [['__scopeId', 'data-v-a01dd0ba']]);
export { x as default };
