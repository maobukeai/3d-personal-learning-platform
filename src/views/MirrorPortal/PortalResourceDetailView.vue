        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          >
            <div
              ...
              class="w-full aspect-[16/9] max-h-[460px] bg-slate-100 dark:bg-slate-800 overflow-hidden border-b border-slate-100 dark:border-slate-800"
            >
              <img
            ...
            <div class="p-5 md:p-7 space-y-5">
              ...
              <div v-if="parseTags(resource.tags).length > 0" class="flex flex-wrap gap-1.5">
                <span
                  ...
                  :key="tag"
                  class="inline-flex items-center gap-1 px-2.5 py-1 text-xs rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 font-medium"
                >
                  <Tag class="w-3 h-3 text-slate-400" />{{ tag }}
                </span>
              </div>
