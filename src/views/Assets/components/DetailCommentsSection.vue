...
import type { CommentItem } from './detailTypes';
interface Props {
...
<template>
  <div class="flex flex-col gap-4 mt-4 pt-6 border-t border-white/10">
    ...
    >
      ...
      <div class="flex justify-end">
        <Button
          variant="primary"
          size="sm"
          :disabled="props.isSubmittingComment || !newCommentContent.trim()"
    ...
    <!-- Comments List -->
    <div v-if="props.isCommentsLoading" class="flex justify-center py-6">
