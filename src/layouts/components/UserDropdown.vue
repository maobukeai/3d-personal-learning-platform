...
<template>
  ...
  >
    <template #trigger>
      <button
        type="button"
        class="p-0.5 sm:px-2.5 sm:py-1 bg-slate-300/80 dark:bg-white/10 hover:bg-slate-300 dark:hover:bg-white/15 transition-all cursor-pointer outline-none min-w-0"
        style="
    ...
    <DropdownItem command="profile" class="rounded-lg my-0.5">
    ...
    <DropdownItem command="notifications" class="rounded-lg my-0.5">
      <div class="flex items-center gap-3 py-1">
    ...
    <DropdownItem command="billing" class="rounded-lg my-0.5">
      <div class="flex items-center gap-3 py-1">
    ...
    <DropdownItem command="logout" class="rounded-lg my-0.5 text-rose-500">
      <div class="flex items-center gap-3 py-1">
