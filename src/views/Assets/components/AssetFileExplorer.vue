...
import type { FlattenedNode } from '@/utils/zipHelper'; /** * Collapsible ZIP package-contents tree for AssetDetailModal. * Purely presentational — tree state is owned by the parent and passed in. * Renders a dedicated Blender SVG mark for .blend files (matching the * original AssetDetailModal behaviour). */
defineProps<{
  packageFiles: string[];
