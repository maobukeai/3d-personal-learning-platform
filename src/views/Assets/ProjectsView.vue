  ...
  <div class="flex-1 flex flex-col h-full overflow-hidden" style="background-color: var(--bg-app)">
    ...
    <div class="flex-1 overflow-y-auto p-10 scrollbar-hide">
      <div class="max-w-[1600px] mx-auto space-y-10">
        <!-- Dashboard Stats -->
        <div
          class="grid grid-cols-1 md:grid-cols-4 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100"
        >
          <div
        ...
        <div
          v-else
          class="bg-white dark:bg-slate-900 rounded-[2.5rem] border shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-8"
          style="border-color: var(--border-base)"
        >
